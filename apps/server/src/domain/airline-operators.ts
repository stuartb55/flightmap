 ...
 *
 * The list is deliberately bundled: operator enrichment must continue to work
 * on an offline installation. Names are user-facing airline brands rather than
 * registered-company names. The primary reference is ICAO's Aeroplane Operator
 * to State Attribution list, supplemented by well-known scheduled operators
 * serving the UK.
 */
